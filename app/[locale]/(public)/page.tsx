          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-lg">
                {isAr ? "تسليم في الوقت المحدد" : "On-time delivery"}
              </CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              {isAr
                ? "نلتزم بالمواعيد المتفق عليها مع متابعة دقيقة لكل مرحلة"
                : "We honor agreed deadlines with careful tracking at every stage."}
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-lg">
                {isAr ? "جودة احترافية" : "Professional quality"}
              </CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              {isAr
                ? "فريق خبراء يقدم حلولاً متكاملة بأفضل المعايير"
                : "An expert team delivering complete solutions to the highest standards."}
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
            ...
            <CardContent className="text-sm text-muted-foreground">
              {isAr
                ? "بوابات دفع موثوقة مع إمكانية التحويل البنكي"
                : "Trusted payment gateways plus bank-transfer support."}
            </CardContent>
          </Card>
        </div>
      </section>
